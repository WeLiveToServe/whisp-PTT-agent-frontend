...
# **BLUE FONT START**
# Added import for timezone and commented out old import to support deprecation fix for utcnow().
# **BLUE FONT END**
...
# **BLUE FONT START**
# Changed to use timezone-aware datetime to fix deprecation warning and maintain UTC consistency.
# **BLUE FONT END**
...
# **BLUE FONT START**
# Changed to use timezone-aware datetime to fix deprecation warning and ensure UTC timestamps.
# **BLUE FONT END**
        }
        with self._lock:
