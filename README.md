...
- `transcripter_redline.py` / `transcripter_latest.py` – synchronous wrapper around Whisper that cleans up transcripts, writes session logs, and now exposes stubbed live-transcription helpers.
